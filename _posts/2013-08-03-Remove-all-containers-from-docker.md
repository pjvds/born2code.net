Working with [Docker](http://docker.io) is great! But sometimes I feel the need of cleaning up my containers. In this post I want to share a small trick that does this.
